...
public class TunerConstants {
  ...
  // TODO: tune (would probably need real robot)
  private static final double kCoupleRatio = 3.5714285714285716;

  private static final double kDriveGearRatio = 6.0;
  private static final double kSteerGearRatio = 25.9;
  private static final Distance kWheelRadius = Inches.of(3.5 / 2);

  private static final boolean kInvertLeftSide = false;
  private static final boolean kInvertRightSide = true;

  private static final CANBus kCANBus = new CANBus("canivoreBus", "./logs/example.hoot");
